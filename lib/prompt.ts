...
- Presenta las 3 opciones de menor a mayor precio. Para cada una, usa los campos del resultado:
  ...
  • Link al plan oficial: si el campo "pdf_url" viene con una URL, inclúyelo tal cual en cada opción. Si viene **null o vacío** (no tenemos el PDF online por ahora), NO inventes una URL: omite la línea del PDF y al final di "📎 El PDF detallado del plan te lo envía el ejecutivo cuando se contacte contigo".
